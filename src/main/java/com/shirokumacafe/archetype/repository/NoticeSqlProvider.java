...
import com.shirokumacafe.archetype.entity.NoticeExample.Criteria;
import com.shirokumacafe.archetype.entity.NoticeExample.Criterion;
...
public class NoticeSqlProvider {
    ...
    public String insertSelective(Notice record) {
        ...
        if (record.getNoticeTitle() != null) {
            VALUES("notice_title", "#{noticeTitle,jdbcType=VARCHAR}");
        }
        ...
        if (record.getNoticeContent() != null) {
            VALUES("notice_content", "#{noticeContent,jdbcType=LONGVARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getNoticeTitle() != null) {
            SET("notice_title = #{record.noticeTitle,jdbcType=VARCHAR}");
        }
        ...
        if (record.getNoticeContent() != null) {
            SET("notice_content = #{record.noticeContent,jdbcType=LONGVARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Notice record) {
        ...
        if (record.getNoticeContent() != null) {
            SET("notice_content = #{noticeContent,jdbcType=LONGVARCHAR}");
        }
