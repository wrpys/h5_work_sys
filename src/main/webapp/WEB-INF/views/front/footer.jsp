...
<footer>
	...
	<h3 class="gongsi login_hide">
		<a href="${ctx}/front/toWorkList" style="line-height: 2.5rem; color: rgb(178, 178, 178);">作业系统</a> |
		<a href="${ctx}/front/logout" style="line-height: 2.5rem; color: rgb(178, 178, 178);">退出</a> |
		<a href="#" style="line-height: 2.5rem; color: rgb(178, 178, 178);" onclick="reloadPage();">刷新</a>
	</h3>
</footer>
<script>
	function reloadPage() {
