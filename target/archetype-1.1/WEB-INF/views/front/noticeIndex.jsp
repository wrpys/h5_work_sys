...
<div class="row row80">
    <ul>
        ...
        <li>
            ...
            <a class="noticeTitle" href="${ctx}/front/noticeDetail?noticeId=${notice.noticeId}" title="${notice.noticeTitle}">
                ${fn:substring(notice.noticeTitle, 0, 40)}</a>
            <span class="noticeName">${notice.nickName}</span>
            <span class="addTime"><fmt:formatDate  value="${notice.addTime}"  pattern="yyyy-MM-dd HH:mm:ss" /></span>
        </li>
        </c:forEach>
    </ul>
    <nav class="pageNum">
